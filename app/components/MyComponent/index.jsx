        ...
        return (
            <Row>
                ...
                <Col md={12}>
                    ...
                    <Button onClick={this.simpleFndark} style={{background: "rgb(97,97,97)", color: "#fff"}}>dark
                        show</Button>
                ...
                <Col md={12} className='demo-tooltip'>
                    ...
                    <Tooltip id="tooltip4" placement="bottom"><strong>Holy guacamole!</strong> Check this
                        info.</Tooltip>
                </Col>
                <Col md={12}>
                    <Col sm={2} xs={4}>
                ...
                <Col md={12} className="height-150">
                    <Select size="lg" defaultValue="lucy" style={{width: 200, marginRight: 6}}
